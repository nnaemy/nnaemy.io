...
function rgbaToRgb(r, g, b, a) {
    return [colorAlphaAjusted(r, a), colorAlphaAjusted(g, a), 
    colorAlphaAjusted(b, a)];
}
...
function convert(e) {
    ...
    document.getElementById('result').innerHTML = "#" + componentToHex(Math.round(r)) +
    componentToHex(Math.round(g)) + componentToHex(Math.round(b));
    return false;
}